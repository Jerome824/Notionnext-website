...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jerome Lau', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '蓝眼蛙怪猛猛游，欢迎关注', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notionnext-website.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Blog, Life, Work', // 网站关键词 英文逗号隔开
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || 'https://www.instagram.com/jerome.2077/', // 您的Instagram地址
  ...
  GREETING_WORDS:
    ...
    'Hello, it is Jerome, welcome to my blog🎉',
