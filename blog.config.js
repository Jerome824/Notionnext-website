...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jerome824', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '平平无奇的蓝眼蛙怪🐸', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notionnext-website.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Blog, Work, Life', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hello, I am Jerome, Welcome to my website🎉',
